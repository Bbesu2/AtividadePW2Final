...
<form action="../controller/midia-create.php" method="post" class="card p-3" >
        <input class="form-control" type="hidden" name="acao" value="<?php echo $midia ? 'editar' : 'adicionar'; ?>">
        <?php if ($midia): ?>
        ...
        <div class="mb-3">
            <label>Nome</label>
            <input class="form-control" type="text" name="nome" id="nome" value="<?php echo $midia->nome ?? ''; ?>">
        </div>
        ...
        <div class="mb-3">
            <label>Sinopse</label>
            <input class="form-control" type="text" name="sinopse" value="<?php echo $midia->sinopse ?? ''; ?>">
        </div>
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="number" min="1940" maxlength="4" name="anoLanc" id="anoLanc" value="<?php echo $midia->anoLanc ?? ''; ?>">
        </div>
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" name="episodio" id="episodio" value="<?php echo $midia->episodio ?? ''; ?>">
        </div>
